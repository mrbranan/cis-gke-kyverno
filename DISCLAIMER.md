# 🛡️ Repository Disclaimer: CIS Benchmark Alignment

This repository provides **community-created implementation examples** (e.g., Kyverno, OpenTofu, Terraform, or Kubernetes policies) intended to **align with** certain controls described in the *CIS Google Kubernetes Engine (GKE) Benchmark v1.6.0* and related cloud-native security best practices.
...
- Kubernetes®, Google Kubernetes Engine (GKE)®, Google Cloud®, and all other trademarks are property of their respective owners.
